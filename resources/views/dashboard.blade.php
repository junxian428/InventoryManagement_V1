    ...
    <div class="dashboard">
      ...
      <div class="ui-row-2">
		...
		C313.862,159.91,315.307,165.822,314.506,173.064z" />
              ...
              <p>Hydraulics & Pneumatics Valve</p>
            </div>
          ...
          <div class="large-banner">
            ...
            <a href="/loginportal" title="Explore">
              Take a Look
            </a>
          ...
          <div class="featured-clay">
            ...
            <div>
              ...
              <div>
                ...
                <a href="/loginportal" title="featured clay">Procure</a>
              </div>
...
document.addEventListener('click', function() {
  window.location.href = '/loginportal'; // Replace with your desired URL
});
