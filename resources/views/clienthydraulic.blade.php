...
<div class="dashboard-river">
  ...
  <div class="dashboard-container">
      ...
      <div class="ui-row-1">
        ...
        <div class="logo-comp">
          <div><svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 297 297" xml:space="preserve">
            ...
            <p><a href="http://localhost:8000/clientdashboard" style=" text-decoration: none; /* Remove underline */
    color: inherit; /* Inherit text color from the parent element */
    cursor: pointer; /* Change cursor to pointer on hover for better UX */">
    Instrument & Electronics Inventory System</a>
  </p>
        </div>
    ...
    <div>
        <!--<div></div>-->
        <img src="{{ $item['link'] }}" alt="SVG Image" width="100" height="100">
        <div>
            <h3>{{ $item['title'] }}</h3>
            ...
            <p>{{ $item['supplier'] }}</p>
            <p>{{ $item['category'] }}</p>
            <!--<p>Image URL: {{ $item['link'] }}</p>-->
            <a href="{{ $item['link'] }}" title="{{ $item['title'] }}">Add into Cart</a>
        </div>
    </div>
@endforeach
