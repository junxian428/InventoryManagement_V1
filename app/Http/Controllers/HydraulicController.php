    ...
    //
     ...
     public function index()
     {
         ...
         */
         ...
         for ($i = 1; $i <= 50; $i++) {
             $plcData[] = [
                 'title' => 'Hyradulic Item ' . $i,
                 'description' => 'Description for Hydraulic Item ' . $i . '.',
         ...
         return view('clienthydraulic', compact('currentPageItems', 'page', 'lastPage'));
         */


         // Retrieve all records from the plc_items table
$plcItems = WorkItem::all();
